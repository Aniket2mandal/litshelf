...
<div class="logo" style="margin-left:10px">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav" style="margin-left:80%">
        ...
        <a class="nav-item nav-link" href="{{route('roles_and_permission.Role.index')}}">Roles</a>
        <a class="nav-item nav-link" href="{{route('roles_and_permission.Role.create')}}">Create Role</a>
...
<div class="card container">
    <div class="card-body">
<form class="container" method="POST" action="{{route('roles_and_permission.Role.store')}}">
    @csrf
